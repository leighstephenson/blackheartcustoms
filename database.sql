...
(3, 'https://blackheartcustoms.s3.us-east-2.amazonaws.com/shinzilla.jpg'),
...
('Frankenstein`s Monster', 'Life-sized, resin wall-hanger painted by George and Leigh Stephenson.  Sculpted by Mike Hill and produced by Black Heart Models. Measures at __ by __ by __. ', 'Boris Karloff’s portrayal of the Monster in the 1931 classic, “Frankenstein” is undoubtedly the best-known, most popular and most widely recognized monster in film history. Based on Mary Shelley’s novel of the same name, “Frankenstein” is as influential as any film in the horror genre. The idea of a scientist assembling body parts from corpses and having that assembly come to life was certainly a shock to  19th century readers and early 20th century movie-goers. Boris Karloff played the role to perfection. ', 1, 3 ),
